...
formin_g1to3 = @ (y) fun_formin(data_1to3, y(1), y(2), p0_g1to4, p1_g1to4, 90, 1e-3, 1e+6, 0.999);

% opt = optimset('TolFun',1e-20,'TolX',1e-20,'MaxFunEvals',1000,'Display','iter');

[pars_1to4] = fmincon(formin_g1to4, startval, [], [], [], [], lb, ub, []);
[pars_1to3] = fmincon(formin_g1to3, startval, [], [], [], [], lb, ub, []);


% The following function collects the varying parameters and formly 
% estimated parameters into a structure
